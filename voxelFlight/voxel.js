...
main::
	...
	movei	#(1024-864)*FP,tmp0
	movei	#(1024-796)*FP,tmp1
	moveta	tmp0,px.a
	moveta	tmp1,py.a
	movei	#MAX_Z,r0
	moveq	#0,r1
...
;;; ------------------------------
	...
	store	currScreen,(blitter)	;_BLIT_A1_BASE
